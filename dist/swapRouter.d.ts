...
declare type AnyTradeType = Trade<Currency, Currency, TradeType> | V3Trade<Currency, Currency, TradeType> | (V3Trade<Currency, Currency, TradeType>)[];
/**
...
export declare abstract class SwapRouter {
     ...
     */
    static swapCallParameters(trades: Trade<Currency, Currency, TradeType> | V3Trade<Currency, Currency, TradeType> | (V3Trade<Currency, Currency, TradeType>)[], options: SwapOptions): MethodParameters;
    /**
     * Produces the on-chain method name to call and the hex encoded parameters to pass as arguments for a given trade.
     * @param trades to produce call parameters for
     * @param options options for the call parameters
