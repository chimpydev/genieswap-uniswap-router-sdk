...
var e,
  ...
  l = '0x0000000000000000000000000000000000000002',
  f = n.BigInt(0),
  m = n.BigInt(1)
function h(t) {
  ...
  return (
    ...
    (t.encodeAddLiquidity = function (e, r, o, u) {
      var a = e.mintAmountsWithSlippage(u),
        ...
        p = a.amount1
      return (
        n.lessThan(r.amount0.quotient, c) && (c = r.amount0.quotient),
        n.lessThan(r.amount1.quotient, p) && (p = r.amount1.quotient),
        h(o)
...
y.INTERFACE = new r.Interface(a.abi)
var w,
  T = (function () {
    function t() {}
    return (
      (t.encodeUnwrapWETH9 = function (e, n, r) {
...
function E() {
  ...
  return (
    ...
    a(y, 'constructor', f),
    a(f, 'constructor', l),
    (l.displayName = a(f, i, 'GeneratorFunction')),
    ...
    (t.mark = function (t) {
      return (
        Object.setPrototypeOf ? Object.setPrototypeOf(t, f) : ((t.__proto__ = f), a(t, i, 'GeneratorFunction')),
    ...
    (I.prototype = {
      ...
      finish: function (t) {
        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
          ...
          if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), g(n), s
        }
      },
      catch: function (t) {
        for (var e = this.tryEntries.length - 1; e >= 0; --e) {
...
;(T.INTERFACE = new r.Interface(p.abi)),
  ((w = exports.Protocol || (exports.Protocol = {})).V2 = 'V2'),
  (w.V3 = 'V3'),
  (w.MIXED = 'MIXED')
var O = (function (t) {
    var e, n
    ...
    return (n = t), ((e = r).prototype = Object.create(n.prototype)), (e.prototype.constructor = e), I(e, n), r
  })(i.Route),
  _ = (function () {
    function t(t) {
      var e = t.v3Routes,
      ...
      for (var r, u = k(e); !(r = u()).done; ) {
        var a = r.value,
          c = a.inputAmount,
          p = a.outputAmount,
          s = new O(a.routev3)
        this.routes.push(s), this.swaps.push({ route: s, inputAmount: c, outputAmount: p })
      }
      this.tradeType = n
      var d = this.swaps[0].inputAmount.currency,
        l = this.swaps[0].outputAmount.currency
      this.swaps.every(function (t) {
        return d.wrapped.equals(t.route.input.wrapped)
      }) || o(!1),
        this.swaps.every(function (t) {
          return l.wrapped.equals(t.route.output.wrapped)
        }) || o(!1)
      for (
        var f,
          m = this.swaps
        ...
        for (var y, A = k(f.value.route.pools); !(y = A()).done; ) {
          var w = y.value
          if (!(w instanceof i.Pool)) throw new Error('Unexpected pool type in route when constructing trade object')
          h.add(i.Pool.getAddress(w.token0, w.token1, w.fee))
        }
      m != h.size && o(!1)
    }
    var e,
      ...
      r = t.prototype
    return (
      (r.minimumAmountOut = function (t, e) {
        if (
          (void 0 === e && (e = this.outputAmount), t.lessThan(f) && o(!1), this.tradeType === c.TradeType.EXACT_OUTPUT)
        )
          return e
        var n = new c.Fraction(m).add(t).invert().multiply(e.quotient).quotient
        return c.CurrencyAmount.fromRawAmount(e.currency, n)
      }),
      (r.maximumAmountIn = function (t, e) {
        if (
          (void 0 === e && (e = this.inputAmount), t.lessThan(f) && o(!1), this.tradeType === c.TradeType.EXACT_INPUT)
        )
          return e
        var n = new c.Fraction(m).add(t).multiply(e.quotient).quotient
        return c.CurrencyAmount.fromRawAmount(e.currency, n)
      }),
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 2:
                    ...
                    return (p = (c = a.value).routev3), (s = c.amount), (e.next = 6), i.Trade.fromRoute(p, s, r)
                  case 6:
                    o.push({ routev3: p, inputAmount: (d = e.sent).inputAmount, outputAmount: d.outputAmount })
                  case 9:
                    e.next = 2
                    break
                  case 11:
                    return e.abrupt('return', new t({ v3Routes: o, tradeType: r }))
                  case 12:
                  case 'end':
                    return e.stop()
                }
      ...
      (t.fromRoute = (function () {
        var e = g(
          E().mark(function e(n, r, o) {
            var u, a
            return E().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    if (((u = []), !(n instanceof i.Route))) {
                      e.next = 9
                      break
                    }
                    return (e.next = 4), i.Trade.fromRoute(n, r, o)
                  case 4:
                    ;(u = [{ routev3: n, inputAmount: (a = e.sent).inputAmount, outputAmount: a.outputAmount }]),
                      (e.next = 10)
                    break
                  case 9:
                    throw new Error('Invalid route type')
                  case 10:
                    return e.abrupt('return', new t({ v3Routes: u, tradeType: o }))
                  case 11:
                  case 'end':
                    return e.stop()
                }
      ...
      (n = [
        ...
        },
        {
          ...
          get: function () {
            ...
            return null != (t = this._executionPrice)
              ? t
              : (this._executionPrice = new c.Price(
                  this.inputAmount.currency,
                  this.outputAmount.currency,
        ...
        },
        {
          ...
          get: function () {
            ...
            for (
              var t, e = c.CurrencyAmount.fromRawAmount(this.outputAmount.currency, 0), n = k(this.swaps);
              !(t = n()).done;
  ...
  N = n.BigInt(0),
  R = new c.Percent(n.BigInt(50), n.BigInt(100)),
  b = (function () {
    function t() {}
    return (
      (t.encodeV3Swap = function (e, n, r, o) {
        for (var u, a = [], p = k(e.swaps); !(u = p()).done; ) {
          var s = u.value,
            f = s.route,
            m = s.outputAmount,
            h = i.toHex(e.maximumAmountIn(n.slippageTolerance, s.inputAmount).quotient),
            v = i.toHex(e.minimumAmountOut(n.slippageTolerance, m).quotient),
            y = 1 === f.pools.length,
            A = r ? l : void 0 === n.recipient ? d : c.validateAndParseAddress(n.recipient)
          if (y)
            a.push(
              e.tradeType === c.TradeType.EXACT_INPUT
                ? t.INTERFACE.encodeFunctionData('exactInputSingle', [
                    {
                      tokenIn: f.tokenPath[0].address,
                      tokenOut: f.tokenPath[1].address,
                      fee: f.pools[0].fee,
                      recipient: A,
                      amountIn: h,
            ...
            var w = i.encodeRouteToPath(f, e.tradeType === c.TradeType.EXACT_OUTPUT)
            a.push(
              e.tradeType === c.TradeType.EXACT_INPUT
                ? t.INTERFACE.encodeFunctionData('exactInput', [
                    { path: w, recipient: A, amountIn: h, amountOutMinimum: o ? 0 : v },
                  ])
                : t.INTERFACE.encodeFunctionData('exactOutput', [
                    { path: w, recipient: A, amountOut: v, amountInMaximum: h },
                  ])
            )
          }
        }
      ...
      (t.encodeSwaps = function (e, n, r) {
        if (e instanceof _) {
          e.swaps.every(function (t) {
            return t.route.protocol == exports.Protocol.V3
          }) || o(!1)
          for (var u, a = [], p = k(e.swaps); !(u = p()).done; ) {
            var s = u.value,
              d = s.route,
              l = s.inputAmount,
              f = s.outputAmount
            if (d.protocol != exports.Protocol.V3) throw new Error('UNSUPPORTED_TRADE_PROTOCOL')
            a.push(i.Trade.createUncheckedTrade({ route: d, inputAmount: l, outputAmount: f, tradeType: e.tradeType }))
          }
          e = a
        }
        Array.isArray(e) || (e = [e])
        var m = e.reduce(function (t, e) {
            return t + (e instanceof i.Trade ? e.swaps.length : 1)
          }, 0),
          h = e[0]
        e.every(function (t) {
          return t.inputAmount.currency.equals(h.inputAmount.currency)
        }) || o(!1),
          e.every(function (t) {
            return t.outputAmount.currency.equals(h.outputAmount.currency)
          }) || o(!1),
          e.every(function (t) {
            return t.tradeType === h.tradeType
          }) || o(!1)
        var v = [],
          y = h.inputAmount.currency.isNative,
          A = h.outputAmount.currency.isNative,
          w = h.tradeType === c.TradeType.EXACT_INPUT && m > 2,
          T = A || !!n.fee || !!r || w
        n.inputTokenPermit &&
          (h.inputAmount.currency.isToken || o(!1),
          v.push(i.SelfPermit.encodePermit(h.inputAmount.currency, n.inputTokenPermit)))
        for (var E, x = k(e); !(E = x()).done; ) {
          var g = E.value
          if (!(g instanceof i.Trade)) throw new Error('Unsupported trade object')
          for (var I, P = k(t.encodeV3Swap(g, n, T, w)); !(I = P()).done; ) v.push(I.value)
        }
        var O = c.CurrencyAmount.fromRawAmount(h.inputAmount.currency, 0),
          N = c.CurrencyAmount.fromRawAmount(h.outputAmount.currency, 0),
      ...
      (t.swapCallParameters = function (e, n) {
        ...
        return (
          r.routerMustCustody &&
            o.push(
              r.outputIsNative
                ? T.encodeUnwrapWETH9(s.quotient, n.recipient, n.fee)
                : T.encodeSweepToken(u.outputAmount.currency.wrapped, s.quotient, n.recipient, n.fee)
            ),
          a &&
            (u.tradeType === c.TradeType.EXACT_OUTPUT || t.riskOfPartialFill(e)) &&
            o.push(i.Payments.encodeRefundETH()),
          { calldata: y.encodeMulticall(o, n.deadlineOrPreviousBlockhash), value: i.toHex(a ? p.quotient : N) }
        )
      }),
      (t.swapAndAddCallParameters = function (e, n, r, u, a, p) {
        var s = t.encodeSwaps(e, n, !0),
          ...
          h = s.totalAmountIn,
          A = s.quoteAmountOut,
          w = s.minimumAmountOut
        n.outputTokenPermit &&
          (A.currency.isToken || o(!1), d.push(i.SelfPermit.encodePermit(A.currency, n.outputTokenPermit)))
        var E = m.route.chainId,
          x = r.pool.token0.wrapped.address === h.currency.wrapped.address,
          g = t.getPositionAmounts(r, x),
          I = g.positionAmountIn,
          P = g.positionAmountOut,
          k = l ? c.WETH9[E] : I.currency.wrapped,
          O = f ? c.WETH9[E] : P.currency.wrapped,
          _ = P.subtract(A.wrapped)
        _.greaterThan(c.CurrencyAmount.fromRawAmount(P.currency, 0)) &&
          d.push(f ? T.encodeWrapETH(_.quotient) : T.encodePull(O, _.quotient)),
          d.push(l ? T.encodeWrapETH(I.quotient) : T.encodePull(k, I.quotient)),
          a !== exports.ApprovalTypes.NOT_REQUIRED && d.push(v.encodeApprove(k, a)),
          p !== exports.ApprovalTypes.NOT_REQUIRED && d.push(v.encodeApprove(O, p))
        var R,
          b = i.Position.fromAmounts({
            pool: r.pool,
            tickLower: r.tickLower,
            tickUpper: r.tickUpper,
            amount0: x ? r.amount0.quotient.toString() : w.quotient.toString(),
            amount1: x ? w.quotient.toString() : r.amount1.quotient.toString(),
            useFullPrecision: !1,
          })
        return (
          d.push(v.encodeAddLiquidity(r, b, u, n.slippageTolerance)),
          d.push(l ? T.encodeUnwrapWETH9(N) : T.encodeSweepToken(k, N)),
          d.push(f ? T.encodeUnwrapWETH9(N) : T.encodeSweepToken(O, N)),
          (R = l ? h.wrapped.add(I.wrapped).quotient : f ? _.quotient : N),
          { calldata: y.encodeMulticall(d, n.deadlineOrPreviousBlockhash), value: R.toString() }
        )
      }),
      ...
      (t.v3TradeWithHighPriceImpact = function (t) {
        return t.priceImpact.greaterThan(R)
      }),
      (t.getPositionAmounts = function (t, e) {
        var n = t.mintAmounts,
          ...
          i = e ? [o, u] : [u, o]
        return { positionAmountIn: i[0], positionAmountOut: i[1] }
      }),
      t
    )
  })()
;(b.INTERFACE = new r.Interface(s.abi)),
  (exports.ADDRESS_THIS = l),
  (exports.ApproveAndCall = v),
  (exports.MSG_SENDER = d),
  (exports.MulticallExtended = y),
  (exports.ONE = m),
  (exports.PaymentsExtended = T),
  (exports.RouteV3 = O),
  (exports.SwapRouter = b),
  (exports.Trade = _),
  (exports.V2_FEE_PATH_PLACEHOLDER = 8388608),
  (exports.ZERO = f),
  (exports.getOutputOfPools = function (t, e) {
    return t.reduce(
      function (t, e) {
        var n = t.inputToken
